...
class DroneController:
    ...
    def __init__(self):
        ...
        self._key_command_mapping = {
            ...
            keyboard.KeyCode.from_char("ı"): "up",
            keyboard.KeyCode.from_char("k"): "down",
            keyboard.KeyCode.from_char("j"): "left",
            keyboard.KeyCode.from_char("l"): "right",
        }
        ...
        self._client.enableApiControl(True, "Drone2")
        self._client.takeoffAsync(vehicle_name="Drone2")
    ...
    def move(self, velocity, yaw_rate):
        self._client.moveByVelocityAsync(velocity[0].item(), velocity[1].item(), velocity[2].item(), self.duration,
                                         ...
                                         yaw_mode=airsim.YawMode(True, yaw_rate),vehicle_name="Drone2")
    ...
    def _handle_commands(self):
        drone_orientation = ScipyRotation.from_quat(self._client.simGetVehiclePose(vehicle_name="Drone2").orientation.to_numpy_array())
